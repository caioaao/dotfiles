...
Detailed reference for creating and managing stow modules in this dotfiles repo.
...
**Adopt Flag (`--adopt`):**
- Use during initial bootstrap: pass `true` as second arg
...
1. **Test on current machine:**
   ...
   just stow new-module true                  # Install
...
just stow problematic-module true
```
