...
description: |
  ...
  Pushes back on your framing, challenges premises, generates implementation
  alternatives. Two modes: Startup (hard diagnostic questions) and Builder
  (enthusiastic design partner for side projects, hackathons, learning).
  Produces a design doc, not code.
...
Write the design document to the working directory as `design-{datetime}.md`.
