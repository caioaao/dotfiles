...
Anchor: `$2` - if not provided, ask which file or directory anchors this feature before doing anything else.
...
4. **Ask structural questions** - the ones whose answers shape the PRD. Use the AskUserQuestion tool, not free-form prose. Examples:
